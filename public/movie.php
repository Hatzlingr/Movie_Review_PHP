            ...
            <div class="d-flex justify-content-between align-items-start">
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <?php if ($user): ?>
                        ...
                        <a href="/action/review_like_toggle.php?review_id=<?= (int)$rev['id'] ?>&redirect=<?= urlencode('/public/movie.php?id=' . $id) ?>"
                            class="btn btn-sm btn-outline-<?= $liked ? 'danger' : 'secondary' ?> like-btn <?= $liked ? 'liked' : '' ?>">
