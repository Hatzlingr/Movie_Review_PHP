...
$perPage        = 20;
$totalDirectors = (int)$pdo->query("SELECT COUNT(*) FROM directors")->fetchColumn();
[$page, $pages, $offset] = calc_pagination($totalDirectors, $perPage, (int)($_GET['page'] ?? 1));
...
<h4 class="fw-bold mb-4"><i class="bi bi-megaphone"></i> Directors <span class="badge bg-secondary fs-6 ms-2"><?= $totalDirectors ?></span></h4>
    ...
    <table class="table table-hover align-middle">
        ...
        <tbody>
            <?php foreach ($directors as $d): ?>
                <tr>
                    <td>
                        <img src="<?= e(imageUrl($d['photo_path'], 'director')) ?>"
                    ...
                    <td class="text-end">
                        <a href="/admin/directors/edit.php?id=<?= (int)$d['id'] ?>"
                            class="btn btn-sm btn-outline-secondary me-1">
                            <i class="bi bi-pencil"></i>
                        </a>
                        <form method="post" action="/admin/directors/delete.php" class="d-inline">
...
<?php render_pagination($page, $pages, '/admin/directors/index.php?'); ?>
